...
const StarButton = ({ text, icon, color = "#4a4a4a", className = "", onClick }) => {
  return (
    <StyledWrapper color={color} className={className} onClick={onClick}>
      <button>
        {icon && <img src={icon} alt="Platform Icon" />}
        {text}
